  ...
  return (
    <div name='home' className='w-full h-screen bg-[#90BEDE]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        <p className='text-[#233dff] text-2xl '>Hi, my name is</p>
        ...
        <div>
          <button className='text-[#0a192f] group border-2 border-[#0a192f] px-6 py-3 my-2 flex items-center hover:bg-[#233dff] hover:border-[#233dff]'>
            View Work
